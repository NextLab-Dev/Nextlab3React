      ...
      <div className="container-fluid  g-0">
        <div className="row justify-content-center">
          <div className="col-12 col-xl-10 p-3">
            ...
            <h3 className="font-weight-bold">Interpretation and Definitions</h3>
            <h3 className="font-weight-bold">Interpretation</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Definitions</h3>
            ...
            <ul>
              ...
              <li>
                ...
                “We”, “Us” or “Our” in this Agreement) refers to Nextlab 3,
                Topličin Venac 19a : 11000 Belgrade, Serbia.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Nextlab 3, accessible from
                https://nextlab3.com
              </li>
              <li>
            ...
            <h3 className="font-weight-bold">Types of Data Collected</h3>
            <h3 className="font-weight-bold">Personal Data</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Usage Data</h3>
            ...
            <h3 className="font-weight-bold">Tracking Technologies and Cookies</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Use of Your Personal Data</h3>
            ...
            <h3 className="font-weight-bold">Retention of Your Personal Data</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Transfer of Your Personal Data</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Disclosure of Your Personal Data</h3>
            <h3 className="font-weight-bold">Business Transactions</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Law enforcement</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Other legal requirements</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Security of Your Personal Data</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Children's Privacy</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Links to Other Websites</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Changes to this Privacy Policy</h3>
            <p>
            ...
            <ul>
              <li>
                By visiting this page on our website: https://nextlab3.com
              </li>
            </ul>
          </div>
        </div>
