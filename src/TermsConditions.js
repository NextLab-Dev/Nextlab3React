      ...
      <div className="container-fluid">
        <div className="row justify-content-center">
          <div className="col-12 col-xl-10 p-3">
            ...
            <h3 className="font-weight-bold">License</h3>
            <p>
              Unless otherwise stated, Nextlab 3 and/or its licensors own the
              intellectual property rights for all material on
              https://nextlab3.com. All intellectual property rights are
              reserved. You may access this from https://nextlab3.com for your
            ...
            <p>
              ...
              Nextlab 3 does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Nextlab 3,its agents and/or affiliates.
              ...
              laws, Nextlab 3 shall not be liable for the Comments or for any
            ...
            <p>
              ...
              Nextlab 3; and (d) the link is in the context of general resource
              information.
            </p>
            <p>
            ...
            <p>
              ...
              by sending an e-mail to Nextlab 3. Please include your name, your
            ...
            <h3 className="font-weight-bold">Content Liability</h3>
            <p>
            ...
            <h3 className="font-weight-bold">Your Privacy</h3>
            <p>Please read Privacy Policy</p>
            <h3 className="font-weight-bold">Reservation of Rights</h3>
            <p>
